...
$(".list-group").on("click", "p", function() {
  //remove current task text when clicked
  var text = $(this)
    .text()
    .trim();
  ...
  //append new text area
  $(this).replaceWith(textInput);
  textInput.trigger("focus");
});

//Event Listener to save edited task text after clicking off task
$(".list-group").on("blur", "textarea", function(){
  ...
  //update tasks info for Local Storage
...
//Delete Tasks by dragging to trash area
$("#trash").droppable({
